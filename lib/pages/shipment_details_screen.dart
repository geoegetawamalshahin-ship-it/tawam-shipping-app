...
import '../data/utils/shipment_status_info.dart';
...
class _ShipmentDetailsScreenState extends State<ShipmentDetailsScreen> {
  late final ShipmentDetailsController _c;

  Map<String, dynamic> get _shipment => Map<String, dynamic>.from(_c.shipment);
  String? get _liveLocation => _c.liveLocation.value;
  String? get _liveLastUpdated => _c.liveLastUpdated.value;
  double? get _liveLatitude => _c.liveLatitude.value;
  double? get _liveLongitude => _c.liveLongitude.value;
  bool get _isLoadingLiveLocation => _c.isLoadingLiveLocation.value;
  String? get _liveLocationError => _c.liveLocationError.value;

  @override
  void initState() {
    super.initState();
    _c = Get.find<ShipmentDetailsController>();
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      _c.shipment.length;
      _c.liveLocation.value;
      _c.isLoadingLiveLocation.value;
  ...
  Widget _buildBody(BuildContext context) {
    ...
    final cargoRaw = _stringValue(_shipment, [
      'cargo',
      'cargoType',
      'type',
    ], fallback: '');
