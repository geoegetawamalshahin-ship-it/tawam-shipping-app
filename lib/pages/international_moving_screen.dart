...
class _InternationalMovingScreenState extends State<InternationalMovingScreen> {
  ...
  late final InternationalMovingController _c;
  ...
  TextEditingController get _roomsController => _c.roomsController;
  TextEditingController get _originFloorController => _c.originFloorController;
  TextEditingController get _destinationFloorController =>
      _c.destinationFloorController;
  TextEditingController get _boxesController => _c.boxesController;
  TextEditingController get _largeItemsController => _c.largeItemsController;
  TextEditingController get _volumeController => _c.volumeController;
  ...
  String get _moveType => _c.moveType.value;
  set _moveType(String value) => _c.moveType.value = value;
  String get _propertyType => _c.propertyType.value;
  set _propertyType(String value) => _c.propertyType.value = value;
  String get _serviceMode => _c.serviceMode.value;
  set _serviceMode(String value) => _c.serviceMode.value = value;
  DateTime? get _movingDate => _c.movingDate.value;
  set _movingDate(DateTime? value) => _c.movingDate.value = value;
  bool get _originElevator => _c.originElevator.value;
  set _originElevator(bool value) => _c.originElevator.value = value;
  bool get _destinationElevator => _c.destinationElevator.value;
  set _destinationElevator(bool value) => _c.destinationElevator.value = value;
  bool get _packingRequired => _c.packingRequired.value;
  set _packingRequired(bool value) => _c.packingRequired.value = value;
  bool get _unpackingRequired => _c.unpackingRequired.value;
  set _unpackingRequired(bool value) => _c.unpackingRequired.value = value;
  bool get _furnitureDisassembly => _c.furnitureDisassembly.value;
  set _furnitureDisassembly(bool value) =>
      _c.furnitureDisassembly.value = value;
  bool get _storageRequired => _c.storageRequired.value;
  set _storageRequired(bool value) => _c.storageRequired.value = value;
  ...
  RxSet<String> get _specialItems => _c.specialItems;
  RxSet<String> get _additionalServices => _c.additionalServices;
  List<String> get _propertyTypes => _c.propertyTypes;
  List<String> get _serviceModes => _c.serviceModes;
  List<String> get _specialItemOptions => _c.specialItemOptions;
  List<String> get _additionalServiceOptions => _c.additionalServiceOptions;
  ...
  void initState() {
    super.initState();
    _c = Get.find<InternationalMovingController>();
  ...
  Widget _buildAdditionalServicesSection() {
    ...
    return ShippingServicesSection(
      ...
      services: _additionalServiceOptions,
  ...
  int get _roomsCount => _c.roomsCount;

  int get _boxCount => _c.boxCount;

  int get _largeItemsCount => _c.largeItemsCount;

  double get _estimatedVolume => _c.estimatedVolume;
  ...
  List<String> get _combinedServices => _c.combinedServices;
  ...
  String _serviceSummaryText(AppLocalizations l10n) {
    ...
    final labels = services
        .map((service) => _optionLabel(l10n, service))
        .toList();
