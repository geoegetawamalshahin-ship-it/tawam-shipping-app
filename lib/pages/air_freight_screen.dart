...
class _AirFreightScreenState extends State<AirFreightScreen> {
  ...
  late final AirFreightController _c;
  ...
  TextEditingController get _piecesController => _c.piecesController;
  ...
  String get _airServiceType => _c.airServiceType.value;
  set _airServiceType(String value) => _c.airServiceType.value = value;
  ...
  double get _grossWeight => _c.grossWeight;
  int get _pieces => _c.pieces;
  double get _volumeCbm => _c.volumeCbmValue;
  double get _volumetricWeight => _c.volumetricWeight;
  double get _chargeableWeight => _c.chargeableWeight;

  @override
  void initState() {
    super.initState();
    _c = Get.find<AirFreightController>();
