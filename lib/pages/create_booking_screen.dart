...
import '../widgets/numbered_section_heading.dart';
...
class _CreateBookingScreenState extends State<CreateBookingScreen> {
  late final CreateBookingFormController _c;
  ...
  List<String> get _preferredTimes => _c.preferredTimes;

  String get _selectedService => _c.selectedService.value;
  set _selectedService(String value) => _c.selectedService.value = value;
  String get _preferredTime => _c.preferredTime.value;
  set _preferredTime(String value) => _c.preferredTime.value = value;
  ...
  void initState() {
    super.initState();
    _c = Get.find<CreateBookingFormController>();
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    return Text(
                      date == null ? l10n.selectDate : _formatDate(l10n, date),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
              ...
              child: Obx(
                () => DropdownButton<String>(
                  ...
                  items: _preferredTimes
                      ...
                      .toList(),
                  onChanged: (value) {
                    if (value != null) _preferredTime = value;
                  },
                ),
              ),
            ),
  ...
  Widget _buildCustomerCard() {
    return Obx(() => _buildCustomerCardBody());
  }

  Widget _buildCustomerCardBody() {
    final l10n = AppLocalizations.of(context)!;
    return _premiumCard(
  ...
  Widget _buildSubmitButton() {
    final l10n = AppLocalizations.of(context)!;
    return Obx(() {
      final submitting = _c.bookings.isSubmitting.value;
      return SizedBox(
        width: double.infinity,
        height: 62,
  ...
  Future<void> _submitBooking() async {
    ...
    switch (outcome.error) {
      ...
      case FormSubmitError.firebase:
        _showMessage(
          outcome.firebaseMessage ?? l10n.unableToSubmitBooking,
          isError: true,
        );
        return;
      default:
