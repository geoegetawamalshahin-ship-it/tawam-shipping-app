...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String get _fullName => _c.fullName.value;
  String get _email => _c.email.value;
  String get _phone => _c.phone.value;
  String get _company => _c.company.value;
  String get _address => _c.address.value;
  String get _selectedLanguage => _c.selectedLanguage.value;
  String get _customerId => _c.customerId.value;

  Future<void> _reload() {
    return Future.wait([
      _c.loadProfile(force: true),
      _c.loadStats(force: true),
    ]);
  }

  Future<void> _saveNotificationPreference(bool value) async {
    _c.messageCode.value = null;
    await _c.saveNotificationPreference(value);

    if (!mounted || _c.messageCode.value == null) return;
  ...
  Future<void> _changeProfilePhoto() async {
    if (_c.isUpdatingPhoto.value) return;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  if (_c.profilePhotoBytes.value == null) {
  ...
  Future<void> _pickAndSavePhoto(ImageSource source) async {
    final l10n = AppLocalizations.of(context)!;
    final code = await _c.pickAndSavePhoto(source);
  ...
  Future<void> _removeProfilePhoto() async {
    final l10n = AppLocalizations.of(context)!;
    final code = await _c.removeProfilePhoto();

    if (!mounted) return;

    _showMessage(
      code == 'removed' ? l10n.profilePhotoRemoved : l10n.couldNotUpdatePhoto,
    );
  }
  ...
  Future<void> _selectLanguage() async {
    ...
    _c.selectedLanguage.value = selected;
  ...
  Future<void> _changePassword() async {
    ...
    final code = await _c.changePassword(
    ...
    _showMessage(_credentialMessage(l10n, code));
  }
  ...
  Future<void> _requestAccountDeletion() async {
    ...
    final code = await _c.requestAccountDeletion(
  ...
  String _credentialMessage(AppLocalizations l10n, String code) {
    switch (code) {
      case 'wrong-password':
  ...
  void _openDocuments() {
    Get.toNamed(AppRoutes.shippingDocuments);
  }
  ...
  Widget _buildProfileAvatar() {
    final l10n = AppLocalizations.of(context)!;
    final updating = _c.isUpdatingPhoto.value;
    final photoBytes = _c.profilePhotoBytes.value;
    ...
    return Tooltip(
      ...
      child: Material(
        color: Colors.transparent,
        child: InkWell(
          onTap: updating ? null : _changeProfilePhoto,
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: ProfileHeaderMetric(
                          value: _c.shipmentsCount.value.toString(),
                      ...
                      Expanded(
                        child: ProfileHeaderMetric(
                          value: _c.inTransitCount.value.toString(),
                      ...
                      Expanded(
                        child: ProfileHeaderMetric(
                          value: _c.quotesCount.value.toString(),
                          label: l10n.quotes,
                        ),
                      ),
                    ],
