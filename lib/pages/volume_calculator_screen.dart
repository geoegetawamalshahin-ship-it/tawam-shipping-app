...
class _VolumeCalculatorScreenState extends State<VolumeCalculatorScreen> {
  ...
  late final VolumeCalculatorController _c;
  ...
  TextEditingController get _actualWeightController =>
      _c.actualWeightController;

  double get _cbm => _c.result.value.cbm;
  double get _airVolWeight => _c.result.value.airVolumetricWeight;
  double get _courierVolWeight => _c.result.value.courierVolumetricWeight;
  double get _chargeableAirWeight => _c.result.value.chargeableAirWeight;
  bool get _hasCalculated => _c.result.value.hasCalculated;

  @override
  void initState() {
    super.initState();
    _c = Get.find<VolumeCalculatorController>();
  }
  ...
  void _requestQuote() {
    ...
    Get.toNamed(
      AppRoutes.getQuote,
      arguments: {
        'lengthCm': _lengthController.text.trim(),
        'widthCm': _widthController.text.trim(),
        'heightCm': _heightController.text.trim(),
        'quantity': _quantityController.text.trim(),
        'weightKg': _actualWeightController.text.trim(),
      },
    );
  }
