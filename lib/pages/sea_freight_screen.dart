...
class _SeaFreightScreenState extends State<SeaFreightScreen> {
  ...
  late final SeaFreightController _c;
  ...
  String get _shipmentType => _c.shipmentType.value;
  set _shipmentType(String value) => _c.shipmentType.value = value;
  String get _serviceMode => _c.serviceMode.value;
  set _serviceMode(String value) => _c.serviceMode.value = value;
  String get _containerType => _c.containerType.value;
  set _containerType(String value) => _c.containerType.value = value;
  ...
  List<String> get _containerTypes => _c.containerTypes;
  ...
  void initState() {
    super.initState();
    _c = Get.find<SeaFreightController>();
  ...
  Widget _summaryBadge(IconData icon, String text) {
    return ShippingSummaryBadge(text: text, icon: icon, showBorder: true);
  }
