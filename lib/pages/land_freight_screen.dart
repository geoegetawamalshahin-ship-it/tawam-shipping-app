...
class _LandFreightScreenState extends State<LandFreightScreen> {
  ...
  late final LandFreightController _c;
  ...
  TextEditingController get _temperatureController => _c.temperatureController;
  ...
  String get _loadType => _c.loadType.value;
  set _loadType(String value) => _c.loadType.value = value;
  String get _weightUnit => _c.weightUnit.value;
  set _weightUnit(String value) => _c.weightUnit.value = value;
  String get _serviceMode => _c.serviceMode.value;
  set _serviceMode(String value) => _c.serviceMode.value = value;
  String get _truckType => _c.truckType.value;
  set _truckType(String value) => _c.truckType.value = value;
  ...
  bool get _dangerousGoods => _c.dangerousGoods.value;
  set _dangerousGoods(bool value) => _c.dangerousGoods.value = value;
  ...
  bool get _oversizedCargo => _c.oversizedCargo.value;
  set _oversizedCargo(bool value) => _c.oversizedCargo.value = value;
  RxSet<String> get _additionalServices => _c.additionalServices;
  List<String> get _weightUnits => _c.weightUnits;
  List<String> get _serviceModes => _c.serviceModes;
  List<String> get _truckTypes => _c.truckTypes;
  ...
  void initState() {
    super.initState();
    _c = Get.find<LandFreightController>();
  ...
  double _currentVolume() => _c.currentVolume();
