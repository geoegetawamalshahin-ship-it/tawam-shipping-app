...
class _TrackShipmentScreenState extends State<TrackShipmentScreen> {
  late final TrackShipmentController _c;
  ...
  void initState() {
    ...
    _c = Get.find<TrackShipmentController>();

    // The controller also reports live-stream problems, so codes are
    // watched instead of only being read after a manual search.
    _messageWorker = ever<String?>(_c.messageCode, _handleMessageCode);
  }
  ...
  void _handleMessageCode(String? code) {
  ...
  void _openShipmentDetails() {
    final shipment = _c.shipment.value;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            controller: _c.trackingController,
          ...
          SizedBox(
            ...
            height: 52,
            child: Obx(() {
              final searching = _c.isSearching.value;
              return ElevatedButton.icon(
                onPressed: searching ? null : _trackShipment,
                icon: searching
                    ? const SizedBox(
                        width: 19,
                        height: 19,
                ...
                label: Text(
                  searching ? l10n.trackingInProgress : l10n.trackShipment,
                  style: const TextStyle(
                    fontWeight: FontWeight.w900,
                    letterSpacing: .45,
                    fontSize: 11,
