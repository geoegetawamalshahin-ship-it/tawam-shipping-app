...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _openNamed(String route, {dynamic arguments}) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          InkWell(
            onTap: () {
              _openNamed(AppRoutes.notifications);
            },
  ...
  Widget _buildServiceGrid(BuildContext context) {
    ...
    final services = <_ServiceItem>[
      _ServiceItem(
        ...
        onTap: () => _openNamed(AppRoutes.seaFreight),
      ),
      _ServiceItem(
        ...
        onTap: () => _openNamed(AppRoutes.airFreight),
      ),
      _ServiceItem(
        ...
        onTap: () => _openNamed(AppRoutes.landFreight),
      ),
      _ServiceItem(
        ...
        onTap: () => _openNamed(AppRoutes.carShipping),
      ),
      _ServiceItem(
        ...
        onTap: () => _openNamed(AppRoutes.internationalMoving),
      ),
      _ServiceItem(
        ...
        onTap: () => _openNamed(AppRoutes.parcelShipping),
      ),
    ];
  ...
  Widget _buildQuickActions(BuildContext context) {
    ...
    final items = [
      ...
      },
      {
        ...
        'onTap': () {
          _openNamed(AppRoutes.createBooking);
        },
      },
      {
        ...
        'onTap': () {
          _openNamed(AppRoutes.volumeCalculator);
        },
      },
      {
        ...
        'onTap': () {
          _openNamed(AppRoutes.trackShipment);
        },
      },
      {
        'title': l10n.myQuotes,
      ...
      },
      {
        ...
        'onTap': () {
          _openNamed(AppRoutes.myBookings);
        },
      },
    ];
        ...
        children: [
          ...
          Expanded(
            child: _navItem(
              ...
              onTap: () {
                _openNamed(AppRoutes.shipments);
              },
            ),
          ),
          Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    premiumItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        _openNamed(AppRoutes.shippingDocuments);
                      },
                    ),
                    premiumItem(
